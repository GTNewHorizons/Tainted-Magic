...
public class LibStrings {
    ...
    public static final String DEPENDENCIES = "required-after:Forge@[10.13.2.1291,);required-after:gtnhlib@[0.9.41,);required-after:Thaumcraft@[4.2.3.5,);after:ThaumicTinkerer";
}
