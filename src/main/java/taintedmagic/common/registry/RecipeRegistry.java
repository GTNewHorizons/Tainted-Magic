    ...
    private static void initInfusion() {
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        6,
                        new AspectList().add(Aspect.AIR, 35).add(Aspect.MOTION, 42).add(Aspect.ENERGY, 42)
                                .add(Aspect.MAGIC, 16),
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        7,
                        new AspectList().add(Aspect.VOID, 56).add(Aspect.MAGIC, 40).add(Aspect.ARMOR, 76)
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        8,
                        new AspectList().add(Aspect.ELDRITCH, 65).add(Aspect.DARKNESS, 30).add(Aspect.TREE, 12)
                                .add(Aspect.MAGIC, 45).add(Aspect.AURA, 35),
                        new ItemStack(BlockRegistry.BlockWarpwoodLog),
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        8,
                        new AspectList().add(Aspect.ELDRITCH, 55).add(Aspect.DARKNESS, 47).add(Aspect.MAGIC, 52)
                                .add(Aspect.METAL, 45).add(Aspect.VOID, 55),
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        4,
                        new AspectList().add(Aspect.TAINT, 45).add(Aspect.LIFE, 24).add(Aspect.MOTION, 24)
                                .add(Aspect.MAGIC, 16).add(Aspect.DEATH, 37),
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        6,
                        new AspectList().add(Aspect.ELDRITCH, 64).add(Aspect.DARKNESS, 32).add(Aspect.MAGIC, 32)
                                .add(Aspect.DEATH, 32).add(Aspect.VOID, 32),
                        new ItemStack(ConfigItems.itemFocusPortableHole),
                        new ItemStack[] { new ItemStack(ConfigItems.itemEldritchObject, 1, 3),
                                new ItemStack(ItemRegistry.ItemMaterial, 1, 3),
                                new ItemStack(ItemRegistry.ItemMaterial, 1, 0), new ItemStack(Items.gold_ingot),
                                new ItemStack(ConfigItems.itemResource, 1, 16),
                                new ItemStack(ItemRegistry.ItemMaterial, 1, 3),
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        new ItemStack(Blocks.iron_block),
                        new ItemStack[] { new ItemStack(ItemRegistry.ItemCrimsonBlood),
                                new ItemStack(Items.gold_nugget), new ItemStack(ItemRegistry.ItemCrimsonBlood),
                                new ItemStack(Items.gold_nugget), new ItemStack(ItemRegistry.ItemCrimsonBlood),
                                new ItemStack(Items.gold_nugget), new ItemStack(ItemRegistry.ItemCrimsonBlood),
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        8,
                        new AspectList().add(Aspect.DARKNESS, 42).add(Aspect.VOID, 56).add(Aspect.ELDRITCH, 38)
                                .add(Aspect.ARMOR, 60).add(Aspect.TRAVEL, 45),
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        3,
                        new AspectList().add(Aspect.METAL, 22).add(Aspect.TOOL, 24).add(Aspect.WEAPON, 14)
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        6,
                        new AspectList().add(Aspect.METAL, 52).add(Aspect.WEAPON, 55).add(Aspect.MAGIC, 32)
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        7,
                        new AspectList().add(Aspect.METAL, 62).add(Aspect.WEAPON, 65).add(Aspect.MAGIC, 42)
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        7,
                        new AspectList().add(Aspect.FLIGHT, 86).add(Aspect.AURA, 56).add(Aspect.SENSES, 25)
                                .add(Aspect.MAGIC, 48).add(Aspect.ENERGY, 65),
                        new ItemStack(ConfigItems.itemPrimalArrow, 1, 0),
                        new ItemStack[] { new ItemStack(ItemRegistry.ItemMaterial, 1, 5),
                                new ItemStack(Items.gold_ingot), new ItemStack(ConfigItems.itemShard, 1, 0),
                                new ItemStack(Items.iron_ingot), new ItemStack(Items.feather),
                                new ItemStack(Items.gold_ingot), new ItemStack(ConfigItems.itemShard, 1, 0),
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        7,
                        new AspectList().add(Aspect.MOTION, 40).add(Aspect.AURA, 20).add(Aspect.TRAVEL, 25)
                                .add(Aspect.MAGIC, 30),
                        new ItemStack(Items.gold_ingot),
                        new ItemStack[] { new ItemStack(ItemRegistry.ItemMaterial, 1, 11),
                                new ItemStack(Items.iron_ingot), new ItemStack(ConfigItems.itemShard, 1, 6),
                                new ItemStack(Items.ender_pearl), new ItemStack(Items.feather),
                                new ItemStack(Items.iron_ingot), new ItemStack(ConfigItems.itemShard, 1, 6),
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        new ItemStack[] { new ItemStack(ItemRegistry.ItemFocusShockwave),
                                new ItemStack(ConfigItems.itemShard, 1, 0), new ItemStack(Items.feather),
                                new ItemStack(Blocks.tnt), new ItemStack(ConfigItems.itemShard, 1, 5),
    ...
    private static void initArcane() {
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addArcaneCraftingRecipe(
                        ...
                        new AspectList().add(Aspect.ORDER, 35).add(Aspect.ENTROPY, 25),
                        " B ",
                        "CAC",
                        " D ",
                        'A',
    ...
    private static void initCrucible() {
        ...
        ResearchRegistry.recipes.put(
                ...
                ThaumcraftApi.addCrucibleRecipe(
                        ...
                        new AspectList().merge(Aspect.MAGIC, 3).merge(Aspect.POISON, 1)));
