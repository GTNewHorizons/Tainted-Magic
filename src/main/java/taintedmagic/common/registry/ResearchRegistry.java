...
public class ResearchRegistry {
    ...
    public static void initResearch() {
        ...
        r.setParents("WARPTREE", "VOIDMETAL", "PRIMPEARL", "ROD_primal_staff").setParentsHidden("SHADOWMETAL")
        ...
        r.setConcealed().setParents("ROD_warpwood").setParentsHidden("CREATIONSHARD").setSecondary()
        ...
        r = new TMResearchItem(
                "WARPTREE",
                new AspectList().add(Aspect.MAGIC, 4).add(Aspect.DARKNESS, 4).add(Aspect.TREE, 4),
                6,
                -2,
        ...
        r.setConcealed().setParents("TMELDRITCHMAJOR").setParentsHidden("PRIMPEARL").setSpecial()
                .registerResearchItem();
        ...
        r.setParentsHidden("PRIMPEARL").setParents("VOIDWALKERBOOTS").setConcealed().setSecondary()
                .registerResearchItem();
        ...
        r = new TMResearchItem(
                "VISHROOMCRAFT",
                new AspectList().add(Aspect.MAGIC, 4).add(Aspect.CRAFT, 2).add(Aspect.PLANT, 3),
                3,
                -3,
        ...
        r.setParentsHidden("ENCHFABRIC", "ESSENTIACRYSTAL", "ELDRITCHMINOR").setParents("TAINTEDMAGIC")
                .registerResearchItem();
        ...
        r.setParents("SHADOWMETAL").setConcealed()
                .setParentsHidden("VOIDFORTRESS", "TMELDRITCHMAJOR", "UNBALANCEDSHARDS").registerResearchItem();
        ...
        r.setParentsHidden("THAUMIUMKATANA").setParents("VOIDFORTRESS").setConcealed().setSecondary()
                .registerResearchItem();
        ...
        r.setParentsHidden("VOIDMETALKATANA").setParents("SHADOWFORTRESS").setConcealed().setSecondary()
                .registerResearchItem();

        r = new TMResearchItem(
                "INSCRIPTIONFIRE",
                new AspectList().add(Aspect.FIRE, 8).add(Aspect.ENTROPY, 4).add(Aspect.METAL, 6),
                14,
                0,
        ...
        r.setParents("THAUMIUMKATANA").setParentsHidden("FOCUSFIRE").setConcealed().setSecondary()
                .registerResearchItem();

        r = new TMResearchItem(
                "INSCRIPTIONTHUNDER",
                new AspectList().add(Aspect.ENTROPY, 8).add(Aspect.MOTION, 4).add(Aspect.METAL, 6),
                14,
                1,
        ...
        r.setParents("THAUMIUMKATANA").setParentsHidden("FOCUSSHOCKWAVE").setConcealed().setSecondary()
                .registerResearchItem();
        ...
        r.setParents("THAUMIUMKATANA").setParentsHidden("BATHSALTS").setConcealed().setSecondary()
                .registerResearchItem();

        r = new TMResearchItem(
                "VOIDGOGGLES",
                new AspectList().add(Aspect.VOID, 8).add(Aspect.DARKNESS, 4).add(Aspect.MAGIC, 6)
        ...
        r.setParents("WARPEDGOGGLES").setParentsHidden("VOIDMETAL").setConcealed().setSecondary()
                .registerResearchItem();
        ...
        r = new TMResearchItem(
                "DIFFUSIONUPGRADE",
                new AspectList().add(Aspect.MAGIC, 4).add(Aspect.DARKNESS, 8).add(Aspect.WEAPON, 8)
        ...
        r = new TMResearchItem(
                "MACEFOCUS",
                new AspectList().add(Aspect.ENTROPY, 10).add(Aspect.EARTH, 4).add(Aspect.WEAPON, 6)
                        .add(Aspect.MAGIC, 8),
                7,
                3,
        ...
        r = new TMResearchItem(
                "FOCUSSHOCKWAVE",
                new AspectList().add(Aspect.MAGIC, 20).add(Aspect.ENTROPY, 12).add(Aspect.AIR, 6)
        ...
        r = new TMResearchItem(
                "TAINTFOCUS",
                new AspectList().add(Aspect.TAINT, 4).add(Aspect.LIFE, 4).add(Aspect.MOTION, 4),
                5,
                2,
        ...
        r = new TMResearchItem(
                "FOCUSLUMOS",
                new AspectList().add(Aspect.FIRE, 16).add(Aspect.LIGHT, 24).add(Aspect.ENERGY, 8),
                5,
                3,
        ...
        r = new TMResearchItem(
                "LUMOSRING",
                new AspectList().add(Aspect.ARMOR, 16).add(Aspect.AURA, 12).add(Aspect.LIGHT, 24).add(Aspect.ENERGY, 8),
                6,
                4,
        ...
        r = new TMResearchItem(
                "FLYTECHARM",
                new AspectList().add(Aspect.FLIGHT, 15).add(Aspect.AIR, 20).add(Aspect.SENSES, 8).add(Aspect.MAGIC, 12),
                13,
                -4,
        ...
        r = new TMResearchItem(
                "GATEKEY",
                new AspectList().add(Aspect.TRAVEL, 30).add(Aspect.EXCHANGE, 15).add(Aspect.AURA, 20)
