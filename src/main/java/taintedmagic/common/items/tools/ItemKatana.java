        ...
        if (stack.hasTagCompound() && stack.stackTagCompound.hasKey(TAG_INSCRIPTION)) {
            list.add(
                    EnumChatFormatting.GOLD + StatCollector.translateToLocal(
                            "text.katana.inscription." + stack.stackTagCompound.getInteger(TAG_INSCRIPTION)));
        }
    }
                ...
                switch (getInscription(stack)) {
                    case 0: {
                        entity.attackEntityFrom(
                                DamageSource.causePlayerDamage((EntityPlayer) player).setFireDamage(),
                    ...
                    case 1: {
                        entity.attackEntityFrom(
                                DamageSource.causePlayerDamage((EntityPlayer) player).setMagicDamage(),
                                getAttackDamage(stack));
                    ...
                    case 2: // heal
                    {
                        ...
                        final List<EntityLivingBase> ents = world.getEntitiesWithinAABB(
                                ...
                                AxisAlignedBB.getBoundingBox(
                                        ...
                                        player.posX + 1,
                                        player.posY + 1,
                                        player.posZ + 1).expand(5.0D, 5.0D, 5.0D));
                        ...
                        if (world.isRemote) {
                            for (int a = 0; a < 18; a++) {
                                ...
                                Thaumcraft.proxy.sparkle(
                                        ...
                                        (float) player.boundingBox.minY + 1.0F
                                                + (float) world.rand.nextGaussian() * 0.5F,
